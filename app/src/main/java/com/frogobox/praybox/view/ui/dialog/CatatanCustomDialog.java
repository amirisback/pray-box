...
public class CatatanCustomDialog {
    ...
    public void DialogForm() {
        ...
        if (mWaktuShalatHelper.saatWaktunyaIsyaPagi()) {
            if (!isEmptyDataToday()) {
                if (isDataNotExistID(VarConstants.Constants.SHUBUH)) mLayoutShubuh.setVisibility(View.VISIBLE);
                if (isDataNotExistID(VarConstants.Constants.DZUHUR)) mLayoutDzuhur.setVisibility(View.VISIBLE);
                if (isDataNotExistID(VarConstants.Constants.ASHAR)) mLayoutAshar.setVisibility(View.VISIBLE);
                if (isDataNotExistID(VarConstants.Constants.MAGHRIB)) mLayoutMaghrib.setVisibility(View.VISIBLE);
                if (isDataNotExistID(VarConstants.Constants.ISYA)) mLayoutIsya.setVisibility(View.VISIBLE);
            } else {
        ...
        mDialog.setPositiveButton("CATAT", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (mCheckBoxShubuh.isChecked()){
                    ...
                    addData(tempIDShubuh, VarConstants.Constants.SHUBUH, tempWaktuShubuh);
                }
                ...
                if (mCheckBoxDzuhur.isChecked()){
                    ...
                    addData(tempIDDzuhur, VarConstants.Constants.DZUHUR, tempWaktuDzuhur);
                }
                ...
                if (mCheckBoxAshar.isChecked()){
                    ...
                    addData(tempIDAshar, VarConstants.Constants.ASHAR, tempWaktuAshar);
                }
                ...
                if (mCheckBoxMaghrib.isChecked()){
                    ...
                    addData(tempIDMaghrib, VarConstants.Constants.MAGHRIB, tempWaktuMaghrib);
                }
                ...
                if (mCheckBoxIsya.isChecked()){
                    ...
                    addData(tempIDIsya, VarConstants.Constants.ISYA, tempWaktuIsya);
                }
    ...
    private void addData(String mId, String mShalat, String mWaktu) {
        try {
            if (isDataNotExistID(mShalat)) {
                if (!mShalat.equals(VarConstants.Constants.BUKAN_WAKTU_SHOLAT)) {
    ...
    public void viewSaveButton(Button mButton, String mShalat){
        if (mShalat.equalsIgnoreCase(VarConstants.Constants.BUKAN_WAKTU_SHOLAT)){
