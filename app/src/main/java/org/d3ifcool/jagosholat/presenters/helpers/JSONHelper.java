...
public class JSONHelper {
    ...
    private static final String BASE_JSON_REPSONSE ="{\n" +
            ...
            "            \"arti\":\"Saya niat melakukan shalat fardhu Shubuh 2 raka'at menghadap kiblat karena Allah Ta'ala\"\n" +
            "         },\n" +
            "         {\n" +
            "            \"niat\":\"Shalat Dzuhur\",\n" +
            ...
            "            \"arti\":\"Saya niat melakukan shalat fardhu Dzuhur 4 raka'at menghadap kiblat karena Allah Ta'al\"\n" +
            "         },\n" +
            "         {\n" +
            "            \"niat\":\"Shalat Ashar\",\n" +
            ...
            "            \"arti\":\"Saya niat melakukan shalat fardhu 'Ashar 4 raka'at menghadap kiblat karena Allah Ta'ala\"\n" +
            "         },\n" +
            "         {\n" +
            "            \"niat\":\"Shalat Maghrib\",\n" +
            ...
            "            \"arti\":\"Saya niat melakukan shalat fardhu Maghrib 3 raka'at menghadap kiblat karena Allah Ta'ala\"\n" +
            "         },\n" +
            "         {\n" +
            "            \"niat\":\"Shalat Isya\",\n" +
            ...
            "            \"arti\":\"Saya niat melakukan shalat fardhu Jum'at 2 raka'at, menghadap kiblat sebagai ma'mum, karena Allah Ta'ala\"\n" +
            "         }\n" +
            "      ],\n" +
            "      \"doa_shalat\":[\n" +
            "         {\n" +
    ...
    public static ArrayList<DataDoaShalat> extractDoaShalat(){
        ArrayList<DataDoaShalat> arrayListDoaShalat = new ArrayList<>();
        try {
            // -------------------------------------------------------------------------------------
            ...
            for (int i = 0 ; i < arrayDoaShalat.length() ; i++){
                ...
                // ---------------------------------------------------------------------------------
                DataDoaShalat doaShalat = new DataDoaShalat(arabDoa,latin,arti);
    ...
    public static ArrayList<DataNiatShalat> extractNiatShalat(){
        ArrayList<DataNiatShalat> arrayListNiatShalat = new ArrayList<>();
        try {
            // -------------------------------------------------------------------------------------
            JSONObject root = new JSONObject(BASE_JSON_REPSONSE);
            ...
            for (int i= 0 ; i<arrayNiatShalat.length();i++){
                ...
                // ---------------------------------------------------------------------------------
                DataNiatShalat niatShalat = new DataNiatShalat(rakaat,niat,arabDoa,latin,arti);
